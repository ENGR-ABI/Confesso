...
export default function AnonymousCardTemplate({ anonyousMessage, isReply = true }) {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {
                isReply ? anonyousMessage.question : anonyousMessage.title
              }
            </div>
          </div>
